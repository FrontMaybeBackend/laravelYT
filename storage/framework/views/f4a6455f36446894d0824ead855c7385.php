                                ...
                                <div class="card h-100 border-0">
                                    <div class="card-img-top">
                                        <?php if(!is_null($product->image_path)): ?>
                                            <img src="<?php echo e(asset('storage/' . $product->image_path)); ?>" class="img-fluid mx-auto d-block" alt="Zdjęcie produktu">
                                            <?php else: ?>
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <h5 class="card-price small">
                                            <i>
                                                ILOŚĆ <?php echo e($product->amount); ?>

                                            </i>
                                        </h5>
                                        <h5 class="card-price small">
                                            <i>
                                                CENA <?php echo e($product->price); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\project\laravelYT\resources\views/welcome.blade.php ENDPATH**/ ?>